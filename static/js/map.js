...
function onSuccessGeolocation(position) {
    ...
    var contentString = [
        ...
        '<img src="./static/img/core-img/favicon.png" width="23" height="23" alt="evmark" class="evmark_search"> Near Charging Stations</a><br /><br />'+
        '<a type="button" class="b_class" target="_blank" rel="noopener noreferrer" href="https://map.naver.com/v5/search/전기차충전소?15,0,0,0,dh">'+
        '<img src="./static/img/core-img/navermap1.png" width="20" height="20" alt="navermark" class="evmark_search"> Searching on Naver</a></center>',
		'</div>'
    ].join('');
